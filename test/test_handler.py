...
def test_lambda_handler_run():
    ...
    with patch('src.extract_lambda.handler.get_latest_data', return_value=dataset_stub):
        # First run
    ...
    assert content == ('[{"sales_order_id": 11165, "created_at": "2024-11-14T10:19:09.990000", '
