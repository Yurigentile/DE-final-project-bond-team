...
def transform_sales_order(sales_order_df):
    ...
    try:
        ...
        fact_sales_order["created_at"] = pd.to_datetime(fact_sales_order["created_at"], format='ISO8601')
        ...
        fact_sales_order["last_updated"] = pd.to_datetime(fact_sales_order["last_updated"], format='ISO8601')
